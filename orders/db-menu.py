...
# TOPPINGS
toppings = [{'name':'Pepperoni', 'price': '1.99'}, {'name':'Sausage','price': '2.99'}, {'name':'Mushrooms', 'price': '1.99'}, {'name':'Onions', 'price': '1.99'}, {'name':'Ham', 'price': '2.99'}, {'name':'Canadian Bacon', 'price': '2.99'}, {'name':'Pineapple','price': '1.99'}, {'name':'Tomato & Basil', 'price': '1.99'}, {'name':'Green Peppers', 'price': '1.99'}, {'name':'Hamburger', 'price': '2.99'}, {'name':'Spinach', 'price': '1.99'}, {'name':'Artichoke', 'price': '1.99'}, {'name':'Buffalo Chicken', 'price': '2.99'}, {'name':'Barbecue Chicken', 'price': '2.99'}, {'name':'Anchovies', 'price': '1.99'}, {'name':'Black Olives', 'price': '1.99'}, {'name':'Fresh Garlic', 'price': '1.99'}, {'name':'Zucchini', 'price': '1.99'}]


for top in toppings:
    name = top.get('name')
    price = top.get('price')
    new = Ingredient(name=name, price=price)
    new.save()
...
hamburger = [
    ...
    {'name':'Tripple Cheese 90g w/ fries ', 'category': 'HAMBURGER',  'price':8.90},
    {'name':'Tripple Cheese 160g w/ fries' , 'category': 'HAMBURGER', 'price':7.85},
    {'name':'Tripple Cheese 220g w/ fries ', 'category': 'HAMBURGER', 'price':5.85},
    {'name':'London Burger 90g w/ fries ', 'category': 'HAMBURGER',  'price':8.90},
    {'name':'London Burger 160g w/ fries' , 'category': 'HAMBURGER', 'price':7.85},
    {'name':'London Burger 220g w/ fries ', 'category': 'HAMBURGER', 'price':5.85},
]
